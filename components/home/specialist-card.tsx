...
export function SpecialistCard({
    ...
    return (
        <Link href="/specialists" className="flex-shrink-0 snap-start w-[150px] sm:w-[185px] lg:w-[200px]">
            <div
          ...
          transition-all duration-300"
            ...
            >
                ...
                <div className="p-3 flex flex-col flex-1">
                    <h3 className="font-bold text-slate-800 text-[13px] leading-tight tracking-tight truncate">{s.name}</h3>
