                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="flex h-18 items-center justify-between">
                        ...
                        <nav className="hidden lg:flex items-center gap-10">
                            <Link
                                href="/catalog"
                                className="text-sm font-medium text-slate-800 border-b-2 border-[#43a047] pb-0.5"
                            >
                                {t("nav.specialists")}
                            </Link>
                            <Link
                            ...
                            {user ? (
                                ...
                                <>
                                    <Link href="/login">
                                        <Button
                                            variant="outline"
                                            className="h-10 rounded-full px-6 text-sm font-medium border-slate-200 text-slate-700 hover:bg-slate-50"
                                        >
                                            {t("btn.login")}
                                        </Button>
                                    </Link>
                    ...
                    <div className="container mx-auto">
                        <div className="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 lg:p-14 overflow-hidden border border-slate-100/80">
                            ...
                            <svg className="absolute right-8 bottom-0 w-80 h-80 text-[#c8e6c9]/50" viewBox="0 0 200 200">
                                <path
                                    fill="currentColor"
                                    d="M45.3,-51.2C58.3,-40.9,68.1,-25.5,71.2,-8.5C74.3,8.5,70.6,27.1,60.1,40.3C49.6,53.5,32.3,61.3,14.1,66.1C-4.1,70.9,-23.2,72.7,-39.7,66.1C-56.2,59.5,-70.1,44.5,-75.4,27C-80.7,9.5,-77.4,-10.5,-68.4,-26.3C-59.4,-42.1,-44.7,-53.7,-29.5,-63.2C-14.3,-72.7,1.4,-80.1,15.7,-77.3C30,-74.5,32.3,-61.5,45.3,-51.2Z"
                            ...
                            <div className="relative z-10 max-w-3xl">
                                ...
                                <p className="text-lg text-slate-500 mb-10 max-w-xl leading-relaxed">{t("hero.subtitle")}</p>
                                        ...
                                        <span
                                            ...
                                            className={`px-5 py-2.5 rounded-full text-sm font-medium cursor-pointer transition-colors ${
                                                i === 0
                                                    ...
                                                    : "bg-white text-slate-600 hover:bg-[#e8f5e9] border border-slate-100/80"
                                            }`}
                                        >
                                            {lang}
                                        </span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {selectedLanguages.map((lang) => {
                                ...
                                return langData ? (
                                    <span
                                        key={lang}
                                        className="inline-flex items-center gap-1 bg-emerald-100 text-emerald-700 px-3 py-1.5 rounded-full text-sm font-medium"
                                    >
                                        {langData.name}
                                        <button onClick={() => toggleLanguage(lang)} className="ml-1 hover:text-emerald-900">
                                            &times;
                                        </button>
                                    </span>
                                ) : null
                    ...
                    <div className="flex gap-8">
                                    ...
                                    <div className="space-y-4">
                                        {languages.map((lang) => (
                                            <label key={lang.id} className="flex items-center gap-3 cursor-pointer group">
                                                ...
                                                />
                                                <span className="text-sm text-slate-600 group-hover:text-slate-800 flex-1">
                                                    {lang.name}
                                                </span>
                        ...
                        <div className="flex-1 space-y-4">
                                ...
                                >
                                    <div className="flex gap-6">
                                        ...
                                        <div className="relative flex-shrink-0">
                                            <div
                                                className={`w-40 h-48 ${specialist.color} rounded-2xl overflow-hidden relative`}
                                            >
                                                {/* Video button */}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-4 mb-4">
                                                <div>
                                                    <div className="flex items-center gap-3 mb-2">
                                                        ...
                                                        >
                                                            <Heart
                                                                className={`h-5 w-5 ${wishlist.includes(specialist.id) ? "fill-rose-500 text-rose-500" : ""}`}
                                                            />
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-x-3 gap-y-2 mt-2 mb-2">
                                                        <div className="flex items-center gap-1.5 bg-[#fff8e1]/80 border border-[#ffc800]/30 px-2 py-1.5 rounded-[8px] shadow-sm">
                                                            ...
                                                            <span className="font-bold text-[#f57c00] text-[14px] leading-none">
                                                                {specialist.rating}
                                                            </span>
                                                        ...
                                                        <div className="flex items-center gap-1.5 bg-[#f0f3f3] border border-slate-200 px-2.5 py-1.5 rounded-[8px] shadow-sm">
                                                            ...
                                                            <span className="text-[13px] font-medium text-[#4d4c53] leading-none">
                                                                <strong className="text-[#121117] font-bold">
                                                                    {specialist.students}
                                                                </strong>{" "}
                                                                учнів
                                                            </span>
                                            ...
                                            <div className="flex items-center gap-3">
                                                <Link href={`/specialists/${specialist.id}`}>
                                                    <Button
                                                        variant="outline"
                                                        className="h-11 rounded-full px-7 text-sm font-medium border-slate-200 hover:bg-slate-50 text-slate-700"
                                                    >
                                                        Детальніше
                                                    </Button>
                                                </Link>
                            ...
                            <div className="text-center py-10">
                                <Button
                                    variant="outline"
                                    className="h-13 rounded-full px-10 border-slate-200 font-medium hover:bg-slate-50 text-slate-700"
                                >
                                    Показати більше
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-2 text-sm">
                                <Link href="/catalog" className="block text-slate-400 hover:text-white">
                                    {t("nav.specialists")}
                                </Link>
                                <Link href="/#how" className="block text-slate-400 hover:text-white">
                                    {t("nav.how_it_works")}
                                </Link>
                                <Link href="/#reviews" className="block text-slate-400 hover:text-white">
                                    {t("nav.reviews")}
                                </Link>
                            </div>
                        </div>
