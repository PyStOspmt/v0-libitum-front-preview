                ...
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-slate-600">
                            <Link href="/specialists" className="text-slate-900">
                                {t("nav.specialists")}
                            </Link>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link href="/register">
                                <Button size="sm" className="rounded-lg bg-slate-900 text-white hover:bg-slate-800 text-sm">
                                    {t("btn.register")}
                                </Button>
                            </Link>
                        </div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                ...
                <div className="pt-4 pb-2">
                    ...
                    <p className="text-[15px] text-slate-600 mt-1 max-w-2xl leading-relaxed">
                        Оберіть з {filtered.length} перевірених спеціалістів. Запишіться на пробне заняття та почніть навчання
                        вже сьогодні.
                    </p>
                </div>
                ...
                <div
                    className="sticky top-14 z-40 bg-white/80 backdrop-blur-md pt-3 pb-2 -mx-4 sm:-mx-6 px-4 sm:px-6 border-b border-transparent [&.stuck]:border-slate-100/50 [&.stuck]:shadow-sm [&.stuck]:bg-white/90"
                    ...
                    {(() => {
                        ...
                        return filtered.map((specialist, index) => {
                            ...
                            return (
                                <div
                                    key={specialist.id}
                                    className="relative group/card z-10 hover:z-[60] transition-all duration-300"
                                >
                                                    ...
                                                    <div className="flex items-center justify-between mb-1.5">
                                                        <div className="flex items-center gap-3 flex-wrap">
                                                            <Link href={`/specialists/${specialist.id}`}>
                                                                <h3 className="text-[22px] font-bold text-[#121117] hover:text-[#43a047] transition-colors leading-tight">
                                                                    {specialist.name}
                                                                </h3>
                                                            </Link>
                                                            {specialist.verified && (
                                                ...
                                                <div className="flex flex-col flex-shrink-0 w-[220px] pl-6 border-l border-slate-100 justify-center gap-5">
                                                    <div className="w-full">
                                                        <div className="flex items-end gap-1 mb-1">
                                                            <span className="text-[32px] font-black text-[#121117] leading-none">
                                                                ₴{specialist.pricePerLesson}
                                                            </span>
                                                        </div>
                                                        <div className="text-[14px] font-medium text-[#69686f]">
                                                            / {specialist.lessonDuration} {t("catalog.lesson") || "заняття"}
                                                        </div>
                                                    </div>

                                                    <Link href={`/specialists/${specialist.id}`} className="w-full mt-2">
                                                        <Button className="w-full h-[48px] rounded-[12px] text-[16px] font-bold text-white transition-colors shadow-sm bg-[#00c5a6] hover:bg-[#00a389]">
                                    ...
                                    >
                                                ...
                                                <div className="relative w-[96px] h-[96px] rounded-xl overflow-hidden bg-slate-100">
                                                    {specialist.image ? (
                                                        ...
                                                        <Avatar className="h-full w-full rounded-xl">
                                                            <AvatarFallback className="bg-slate-100 text-lg font-bold text-slate-600 rounded-xl">
                                                                {specialist.name[0]}
                                                            </AvatarFallback>
                                                        </Avatar>
                                                    )}
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center justify-between mb-1">
                                                    <div className="flex items-center gap-1.5">
                                                        <Link href={`/specialists/${specialist.id}`}>
                                                            <h3 className="text-[16px] font-semibold text-[#121117] leading-tight">
                                                                {specialist.name}
                                                            </h3>
                                                        </Link>
                                                        {specialist.verified && (
                                                            <Award className="h-3.5 w-3.5 text-[#00c5a6] flex-shrink-0" />
                                                        )}
                                                    </div>
                                                    <button
                                                        onClick={(e) => toggleFavorite(e, specialist.id)}
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    <span
                                                        className={`text-[10px] font-semibold px-2 py-0.5 rounded ${a.badge} border-transparent inline-flex items-center`}
                                                    >
                                                        <div
                                                            className={`w-1 h-1 rounded-full mr-1 ${a.icon.replace("text", "bg")}`}
                                                        ></div>
                                                        {specialist.specialization}
                                                    </span>
                                                </div>
                                        ...
                                        >
                                            <p
                                                className={`text-[15px] text-[#3e3d45] leading-relaxed font-medium ${isExpanded ? "" : "line-clamp-2"}`}
                                            >
                                        ...
                                        <div className="bg-[#f0f3f3]/50 rounded-[16px] p-4 flex items-center justify-between border border-slate-100 mt-auto">
                                            <div>
                                                <div className="text-[24px] font-bold text-[#121117] leading-none mb-1.5">
                                                    ₴{specialist.pricePerLesson}
                                                </div>
                                                <div className="text-[13px] font-medium text-[#69686f]">
                                        ...
                                        <Link href={`/specialists/${specialist.id}`} className="block w-full mt-4">
                                            <Button className="w-full h-11 rounded-[10px] text-[15px] font-bold text-white transition-colors shadow-sm bg-[#00c5a6] hover:bg-[#00a389]">
                                                {t("catalog.book_lesson") || "Залишити заявку"}
                                            </Button>
                                        </Link>
                                    </article>
