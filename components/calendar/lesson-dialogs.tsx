                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[1.3fr_0.7fr] gap-0 md:gap-6">
                            ...
                            <div className="p-4 md:p-8 space-y-6">
                                    ...
                                    <Avatar className="h-16 w-16 md:h-20 md:w-20 rounded-[12px] border border-slate-200/80 shadow-sm shrink-0">
                                        {selectedLesson.photoUrl && (
                                            <AvatarImage
                                                ...
                                                alt={selectedLesson.specialistName || selectedLesson.clientName}
                                                className="rounded-[12px] object-cover"
                                            />
                                        )}
                                        <AvatarFallback className="bg-[#f0f3f3] text-[#121117] font-[600] text-[24px] rounded-[12px]">
                                            {userType === "client"
                                                ? selectedLesson.specialistName?.[0]
                                                : selectedLesson.clientName?.[0]}
                                        </AvatarFallback>
                                    </Avatar>
                                    <div className="flex-1 min-w-0 space-y-2.5 mt-1">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            <Badge
                                                variant="secondary"
                                                className={cn(
                                                    "px-3 py-1 text-[13px] font-[600] border-0 rounded-[6px]",
                                                    selectedLesson.subject === "Психологія"
                                            ...
                                            <span className="text-[13px] font-[500] text-[#69686f] bg-[#f0f3f3] px-2 py-1 rounded-[6px]">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 rounded-[16px] border border-slate-200/80 bg-white p-4 md:p-5 shadow-[0_4px_12px_rgba(0,0,0,0.03)]">
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="text-[13px] font-[600] text-[#69686f] flex items-center gap-1.5">
                                            <DollarSign className="h-4 w-4" /> Оплата
                                        </div>
                                        <div className="text-[14px] md:text-[15px] font-[600] text-[#121117] whitespace-normal flex items-center gap-2">
                                            {selectedLesson.price} ₴
                                            <Badge
                                                variant="outline"
                                                className={`border-0 rounded-[6px] px-2 py-0.5 text-[11px] ${selectedLesson.isPaid ? "bg-[#e8f5e9] text-[#2e7d32]" : "bg-[#fff8e1] text-[#f57c00]"}`}
                                            >
                                ...
                                {selectedLesson.description && (
                                    <div className="space-y-2 bg-[#f0f3f3] rounded-[16px] p-4 md:p-5">
                                        ...
                                        <div className="text-[14px] md:text-[15px] text-[#69686f] leading-relaxed">
                                            {selectedLesson.description}
                                        </div>
                                    </div>
                                )}
                                ...
                                {userType === "tutor" && selectedLesson && <LessonGoalsSection lessonId={selectedLesson.id} />}
                            </div>
                            ...
                            <div className="bg-[#f0f3f3] border-t md:border-t-0 md:border-l border-slate-200/80 p-4 md:p-8 space-y-4">
                                ...
                                <div className="flex flex-col gap-3">
                                    {selectedLesson.format === "online" && selectedLesson.meetingUrl && (
                                        <Button
                                            asChild
                                            className="justify-center gap-2 w-full whitespace-normal text-center h-[48px] rounded-[8px] bg-[#121117] text-white hover:bg-[#121117]/90 font-[600] text-[16px] transition-colors duration-[220ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
                                        >
                                    ...
                                    {selectedLesson.format === "offline" && selectedLesson.location && (
                                        <Button
                                            asChild
                                            variant="outline"
                                            className="justify-center gap-2 w-full whitespace-normal text-center h-[48px] rounded-[8px] border-2 border-[#121117] text-[#121117] bg-white hover:bg-gray-50 font-[600] text-[16px] transition-colors duration-[220ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
                                        >
                                            <a
                ...
                <DialogContent className="max-w-3xl p-8 rounded-[24px] font-sans">
                    <DialogHeader className="mb-6">
                        ...
                        <DialogDescription className="text-[15px] text-[#69686f] mt-1">
                            Заповніть інформацію про нове заняття в розкладі
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-6">
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="clientName" className="text-[14px] font-[600] text-[#121117]">
                                    Ім'я учня *
                                </Label>
                                <Input
                                    id="clientName"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="subject" className="text-[14px] font-[600] text-[#121117]">
                                    Предмет *
                                </Label>
                                <Input
                                    id="subject"
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="date" className="text-[14px] font-[600] text-[#121117]">
                                    Дата *
                                </Label>
                                <Input
                                    id="date"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="time" className="text-[14px] font-[600] text-[#121117]">
                                    Час *
                                </Label>
                                <Input
                                    id="time"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="duration" className="text-[14px] font-[600] text-[#121117]">
                                    Тривалість (хв)
                                </Label>
                                <Select
                                ...
                                >
                                    ...
                                    <SelectContent className="rounded-[12px] border-slate-200 shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
                                        <SelectItem
                                            value="30"
                                            className="rounded-[8px] focus:bg-gray-50 focus:text-[#121117] cursor-pointer"
                                        >
                                            30 хвилин
                                        </SelectItem>
                                        <SelectItem
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="format" className="text-[14px] font-[600] text-[#121117]">
                                    Формат
                                </Label>
                                <Select
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="price" className="text-[14px] font-[600] text-[#121117]">
                                    Ціна (₴)
                                </Label>
                                <Input
                                    id="price"
                        ...
                        {formData.format === "offline" && (
                            <div className="space-y-2">
                                <Label htmlFor="location" className="text-[14px] font-[600] text-[#121117]">
                                    Адреса
                                </Label>
                                <Input
                                    id="location"
                        ...
                        {formData.format === "online" && (
                            <div className="space-y-2">
                                <Label htmlFor="meetingUrl" className="text-[14px] font-[600] text-[#121117]">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="topic" className="text-[14px] font-[600] text-[#121117]">
                                Тема заняття
                            </Label>
                            <Input
                                id="topic"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="description" className="text-[14px] font-[600] text-[#121117]">
                                Опис
                            </Label>
                            <Textarea
                                id="description"
                    ...
                    <DialogFooter className="mt-8 gap-3 sm:gap-0">
                        <Button
                            ...
                            className="h-[48px] px-8 rounded-[8px] border-2 border-[#121117] text-[#121117] font-[600] text-[16px] hover:bg-gray-50 transition-colors"
                        >
                            Скасувати
                        </Button>
                        <Button
                            onClick={onAdd}
                            className="h-[48px] px-8 rounded-[8px] border-2 border-transparent bg-[#00c5a6] text-white hover:bg-[#00c5a6]/90 font-[600] text-[16px] transition-colors"
                        >
                            Додати заняття
                        </Button>
                    </DialogFooter>
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent className="max-w-3xl p-8 rounded-[24px] font-sans">
                    <DialogHeader className="mb-6">
                        ...
                        <DialogDescription className="text-[15px] text-[#69686f] mt-1">
                            Оновіть інформацію про заняття
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-6">
                        <div className="grid grid-cols-3 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="edit-time" className="text-[14px] font-[600] text-[#121117]">
                                    Час
                                </Label>
                                <Input
                                    id="edit-time"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="edit-duration" className="text-[14px] font-[600] text-[#121117]">
                                    Тривалість (хв)
                                </Label>
                                <Select
                                    value={formData.duration}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="edit-format" className="text-[14px] font-[600] text-[#121117]">
                                    Формат
                                </Label>
                                <Select
                                    value={formData.format}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="edit-price" className="text-[14px] font-[600] text-[#121117]">
                                Ціна (₴)
                            </Label>
                            <Input
                                id="edit-price"
                        ...
                        {formData.format === "offline" && (
                            <div className="space-y-2">
                                <Label htmlFor="edit-location" className="text-[14px] font-[600] text-[#121117]">
                                    Адреса
                                </Label>
                                <Input
                                    id="edit-location"
                        ...
                        {formData.format === "online" && (
                            <div className="space-y-2">
                                <Label htmlFor="edit-meetingUrl" className="text-[14px] font-[600] text-[#121117]">
                                    Посилання на зустріч
                                </Label>
                                <Input
                                    id="edit-meetingUrl"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="edit-topic" className="text-[14px] font-[600] text-[#121117]">
                                Тема заняття
                            </Label>
                            <Input
                                id="edit-topic"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="edit-description" className="text-[14px] font-[600] text-[#121117]">
                                Опис
                            </Label>
                            <Textarea
                                id="edit-description"
