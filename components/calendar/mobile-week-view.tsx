        ...
        <div className="flex flex-col gap-3 font-sans">
            ...
            <div className="flex items-center justify-between px-2 py-3">
                <h3 className="text-lg font-[700] text-[#121117]">
                    {weekDates[0].getDate()} {monthNames[weekDates[0].getMonth()]} - {weekDates[6].getDate()}{" "}
                    {monthNames[weekDates[6].getMonth()]}
                </h3>
                <div className="text-[14px] font-[500] text-[#69686f]">{weekDates[0].getFullYear()}</div>
            </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="text-[11px] font-[600] text-[#69686f] mb-1 truncate text-center w-full">
                                <span className="block sm:hidden uppercase tracking-wide">
                                    {weekDaysMobileShort[date.getDay()]}
                                </span>
                            ...
                            {totalItems > 0 && (
                                <div className="mt-2 flex flex-col items-center gap-1">
                                    <div className="flex items-center gap-1">
                                        {dayLessons.length > 0 && <div className="h-2.5 w-2.5 rounded-full bg-[#00c5a6]" />}
                                        {dayEvents.length > 0 && <div className="h-2.5 w-2.5 rounded-full bg-purple-500" />}
                                    </div>
                                    <div className="text-[11px] text-[#69686f] font-[600]">{totalItems}</div>
                                </div>
                            )}
                        </div>
                    )
            ...
            <div className="mt-4">
                <h4 className="text-[15px] font-[700] text-[#121117] mb-3 px-2">Найближчі заняття на цьому тижні</h4>
