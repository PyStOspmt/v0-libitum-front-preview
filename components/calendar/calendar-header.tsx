      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as ViewMode)}>
          <TabsList className="h-[40px] sm:h-[48px] rounded-[8px] bg-[#f0f3f3] p-1">
            <TabsTrigger value="day" className="text-[14px] sm:text-[15px] font-[600] px-4 rounded-[6px] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm">День</TabsTrigger>
            <TabsTrigger value="week" className="text-[14px] sm:text-[15px] font-[600] px-4 rounded-[6px] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm">Тиждень</TabsTrigger>
            <TabsTrigger value="month" className="text-[14px] sm:text-[15px] font-[600] px-4 rounded-[6px] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm">Місяць</TabsTrigger>
          </TabsList>
        </Tabs>
