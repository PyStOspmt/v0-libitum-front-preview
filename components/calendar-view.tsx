...
import { ChevronLeft, ChevronRight, CalendarIcon, Clock, Video, MapPin } from "lucide-react"
          ...
          <div className="grid grid-cols-7 gap-2">
            {weekDates.map((date, index) => {
              ...
              return (
                <div
                  key={index}
                  className={cn("min-h-[200px] rounded-lg border p-2", isTodayDate && "border-primary bg-primary/5")}
                >
                  ...
                  <div className="space-y-2">
                    {daySessions.map((session) => (
                      ...
                      >
                        ...
                        <Badge variant={session.type === "online" ? "default" : "secondary"} className="h-4 text-[9px]">
                          {session.type === "online" ? (
                            <>
