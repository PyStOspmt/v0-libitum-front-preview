...
export type RegisterWithEmailAndPasswordMutation = {
    __typename?: "Mutation"
    user: {
        __typename?: "UserType"
        id: string
...
export type RequestTelegramVerificationMutation = {
    __typename?: "Mutation"
    requestTelegramVerification: { __typename?: "TelegramRedirectType"; token: string }
}
...
export const LoginWithEmailAndPasswordDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "LoginWithEmailAndPassword" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "userPayload" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "LoginWithEmailAndPasswordDto" } },
                    },
                },
            ],
            selectionSet: {
...
} as unknown as DocumentNode<LoginWithEmailAndPasswordMutation, LoginWithEmailAndPasswordMutationVariables>
    ...
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "RegisterWithEmailAndPassword" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "userPayload" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "RegisterWithEmailAndPasswordDto" } },
                    },
                },
            ],
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        alias: { kind: "Name", value: "user" },
                        name: { kind: "Name", value: "registerUserWithEmailAndPassword" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "userPayload" },
...
} as unknown as DocumentNode<RegisterWithEmailAndPasswordMutation, RegisterWithEmailAndPasswordMutationVariables>
export const RequestOAuthUrlDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "requestOAuthUrl" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    ...
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "RequestOAuthUrlDto" } },
                    },
                },
            ],
            selectionSet: {
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "requestOAuthUrlDto" },
...
} as unknown as DocumentNode<RequestOAuthUrlMutation, RequestOAuthUrlMutationVariables>
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "requestResetPasswordPayload" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "RequestResetPasswordDto" } },
                    },
                },
            ],
            selectionSet: {
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "requestResetPasswordPayload" },
                                value: { kind: "Variable", name: { kind: "Name", value: "requestResetPasswordPayload" } },
                            },
                        ],
                    },
                ],
...
} as unknown as DocumentNode<RequestTelegramVerificationMutation, RequestTelegramVerificationMutationVariables>
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "resetPasswordPayload" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "ConfirmPasswordResetDto" } },
                    },
                },
            ],
            selectionSet: {
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "resetPasswordPayload" },
                                value: { kind: "Variable", name: { kind: "Name", value: "resetPasswordPayload" } },
                            },
                        ],
                    },
                ],
...
} as unknown as DocumentNode<ConfirmResetPasswordMutation, ConfirmResetPasswordMutationVariables>
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "verifyUserPayload" } },
                    type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "VerifyUserDto" } } },
                },
            ],
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "verifyUserPayload" },
                                value: { kind: "Variable", name: { kind: "Name", value: "verifyUserPayload" } },
                            },
                        ],
                    },
                ],
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: "Field", name: { kind: "Name", value: "passingScore" } },
                                {
                                    kind: "Field",
...
} as unknown as DocumentNode<GetQuizzesQuery, GetQuizzesQueryVariables>
    ...
    definitions: [
        {
            ...
            selectionSet: {
                kind: "SelectionSet",
                selections: [{ kind: "Field", name: { kind: "Name", value: "resendVerificationEmail" } }],
            },
        },
    ],
} as unknown as DocumentNode<ResendVerificationEmailMutation, ResendVerificationEmailMutationVariables>
