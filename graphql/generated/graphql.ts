...
export type GetQuizzesQuery = { __typename?: 'Query', quizes: Array<{ __typename?: 'QuizType', id: string, title: string, description?: string | null, type: QuizTarget, passingScore: number, createdAt: any, updatedAt: any, questions: Array<{ __typename?: 'QuizQuestionType', explanation?: string | null, id: string, mediaId?: string | null, order: number, text: string, options: Array<{ __typename?: 'QuizOptionType', id: string, text: string }> }> }> };
