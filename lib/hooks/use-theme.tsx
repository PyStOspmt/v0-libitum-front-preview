    ...
    useEffect(() => {
        ...
        if (savedTheme && ["tutor", "psychologist", "speech-therapist"].includes(savedTheme)) {
            ...
            if (user.legacyRole === "admin") {
                ...
                const isSpeechTherapist = subjects.some(
                    (s: string) => s.toLowerCase().includes("логоп") || s.toLowerCase().includes("speech"),
                )
            ...
            >
                ...
                {isSpecialistTheme && (
                    <div
                        ...
                        style={{
                            background:
                                theme.type === "psychologist" || theme.type === "speech-therapist"
                                    ? `
