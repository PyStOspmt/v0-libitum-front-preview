...
export function ClientRequestsPage() {
    ...
    const activeRequests = clientRequests.filter((req) => ["accepted", "communicating", "trial_scheduled"].includes(req.status))
    const completedRequests = clientRequests.filter((req) =>
                            ...
                            {tabs.map((tab) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Badge
                                            variant="secondary"
                                            className={`ml-1 px-1.5 py-0.5 text-[11px] ${
                                                activeTab === tab.id
                                                    ? tab.color === "amber"
                                                ...
                                                <div className="mt-6 grid gap-3 text-left">
                                                    <div className="rounded-xl border border-slate-200 p-3 bg-white text-sm text-slate-700">
                                                        ...
                                                        <div className="text-slate-500">
                                                            13 лютого, 18:30 • Онлайн • Узгодження деталей
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="py-8 text-center">
                                                ...
                                                <div className="mt-6 grid gap-3 text-left">
                                                    <div className="rounded-xl border border-slate-200 p-3 bg-white text-sm text-slate-700">
                                                        ...
                                                        <div className="text-slate-500">
                                                            5 лютого, 16:00 • Офлайн • Оцінка результатів
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
