                ...
                <div className="p-3 sm:p-6 lg:p-10 max-w-[1200px] mx-auto space-y-6 sm:space-y-8 font-sans">
                    ...
                    <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        >
                            ...
                            <p className="mt-4 text-[32px] font-bold text-[#121117] leading-none">{stats.activeSpecialists}</p>
                        ...
                        >
                            ...
                            <p className="mt-4 text-[32px] font-bold text-[#121117] leading-none">{stats.completedSessions}</p>
                        ...
                        >
                            ...
                            <p className="mt-4 text-[32px] font-bold text-[#121117] leading-none">{stats.upcomingSessions}</p>
                        ...
                        >
                            ...
                            <p className="mt-4 text-[32px] font-bold text-[#121117] leading-none">{levelInfo.level}</p>
