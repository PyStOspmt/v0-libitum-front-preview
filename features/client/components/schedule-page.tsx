                ...
                <div className="container mx-auto max-w-[1200px] space-y-4 sm:space-y-8 px-1 py-4 sm:p-6 font-sans">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="text-[32px] font-bold text-[#121117] leading-none mb-2 sm:mb-6">
                                ...
                                {lessons
                                    ...
                                    .map((lesson) =>
                                        (() => {
                                            ...
                                            const cardBorder = isPsychology
                                                ? "border-orange-200/80 hover:border-orange-300/80"
                                                : "border-slate-200/80 hover:border-[#00c5a6]/50"
                                        ...
                                        >
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="space-y-2">
                                                    <div className="font-[600] text-[18px] text-[#121117] leading-tight">
                                                        {lesson.subject}
                                                    </div>
                                                    ...
                                                    <div className="text-[13px] text-[#69686f] flex items-center gap-2 flex-wrap">
                                                        ...
                                                        {lesson.topic && (
                                                            <span className="bg-white px-2 py-1 rounded-[6px] border border-gray-200 truncate max-w-[200px]">
                                                                {lesson.topic}
                                                            </span>
                                                        )}
                                                    </div>
                                                    {lesson.report?.comment && (
                                                        <p className="text-[14px] text-[#69686f] line-clamp-2 mt-2 bg-white p-3 rounded-[8px] border border-gray-200/50">
                                                            {lesson.report.comment}
                                                        </p>
                                                    )}
                                                </div>
                                            ...
                                            <div className="text-left sm:text-right space-y-2 mt-4 sm:mt-0 pt-4 sm:pt-0 border-t border-gray-100 sm:border-0 w-full sm:w-auto">
                                                ...
                                                <div className="text-[13px] font-[500] text-[#69686f] mt-2 sm:mt-0">
                                                    Завершено
                                                </div>
                                            </div>
                                        </div>
