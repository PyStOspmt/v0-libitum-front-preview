...
import { DollarSign, CreditCard, Clock, CheckCircle2, AlertTriangle, Calendar } from "lucide-react"
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex items-center justify-between rounded-lg border border-green-200 bg-green-50 p-3">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Разовий платіж за успішну заявку</p>
                        </div>
