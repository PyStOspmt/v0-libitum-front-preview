...
const lessonTags = [
    {
        id: "tag-1",
        text: "Мені пора на пенсію - ти краще вчителя!",
        color: "bg-emerald-100 text-emerald-800 border-emerald-200",
    },
    {
        id: "tag-2",
        text: "Забуваємо цей урок як страшний сон. Чекаю на камбек.",
                ...
                <div className="container mx-auto max-w-[1200px] space-y-8 p-6 font-sans">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <Button
                            ...
                            className="h-[48px] px-6 rounded-[8px] bg-[var(--theme-primary)] hover:bg-[var(--theme-primary-hover)] text-white font-[600] text-[16px] transition-colors shadow-sm shrink-0"
                        >
                    ...
                    <Tabs defaultValue="submitted" className="w-full">
                        <TabsList className="flex w-full flex-col sm:flex-row h-auto sm:h-[48px] bg-[#f0f3f3] rounded-[12px] p-1 gap-1">
                            <TabsTrigger
                                value="submitted"
                                className="w-full rounded-[8px] text-[15px] font-[600] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm text-[#69686f] py-2 sm:py-0"
                            >
                                На перевірці ({submittedHomeworks.length})
                            </TabsTrigger>
                            <TabsTrigger
                                value="checked"
                                className="w-full rounded-[8px] text-[15px] font-[600] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm text-[#69686f] py-2 sm:py-0"
                            >
                                Перевірені ({checkedHomeworks.length})
                            </TabsTrigger>
                            <TabsTrigger
                                value="pending"
                                className="w-full rounded-[8px] text-[15px] font-[600] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm text-[#69686f] py-2 sm:py-0"
                            >
                                Очікують ({pendingHomeworks.length})
                            </TabsTrigger>
                        </TabsList>
                            ...
                            {submittedHomeworks.length > 0 ? (
                                <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2">
                                    {submittedHomeworks.map((hw) => (
                                        <Card
                                            key={hw.id}
                                            className="border-slate-200/80 shadow-[0_4px_12px_rgba(0,0,0,0.03)] rounded-[20px] transition-all hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)]"
                                        >
                                                ...
                                                <div className="flex items-start justify-between gap-4">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <CardDescription className="text-[14px] text-[#69686f] font-[500]">
                                                            {hw.clientName} •{" "}
                                                            <span className="text-[var(--theme-primary)]">{hw.subject}</span>
                                                        </CardDescription>
                                                    </div>
                                            ...
                                            <CardContent className="space-y-5">
                                                ...
                                                <Button
                                                    className="w-full h-[44px] rounded-[8px] bg-[#121117] hover:bg-[#121117]/90 text-white font-[600] transition-colors"
                            ...
                            {checkedHomeworks.length > 0 ? (
                                <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2">
                                    {checkedHomeworks.map((hw) => (
                                        <Card
                                            key={hw.id}
                                            className="border-slate-200/80 shadow-[0_4px_12px_rgba(0,0,0,0.03)] rounded-[20px]"
                                        >
                                            <CardHeader className="pb-4">
                                                <div className="flex items-start justify-between gap-4">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <CardDescription className="text-[14px] text-[#69686f] font-[500]">
                                                            {hw.clientName} •{" "}
                                                            <span className="text-[var(--theme-primary-dark)]">
                                                                {hw.subject}
                                                            </span>
                                                        </CardDescription>
                                                    </div>
                                                    <div className="flex items-center gap-1 bg-[#fff8e1] px-3 py-1.5 rounded-[8px] text-[#f57c00] font-bold">
                                                        ...
                                                        <span className="text-[16px]">{hw.grade}</span>
                                                        <span className="text-[12px] opacity-70">/5</span>
                                                    </div>
                                                </div>
                                            </CardHeader>
                                            <CardContent className="space-y-5">
                                                <p className="text-[14px] text-[#69686f] leading-relaxed line-clamp-2">
                                                    {hw.description}
                                                </p>
                                                {hw.feedback && (
                                                    <div className="rounded-[12px] bg-[#f0f3f3] p-4 border border-slate-200/50">
                                                        <p className="text-[13px] font-[600] text-[#121117] mb-1.5">
                                                            Ваш відгук та звіт:
                                                        </p>
                                                ...
                                                <div className="flex items-center text-[13px] font-[500] text-[#69686f]">
                                                    ...
                                                    Перевірено:{" "}
                                                    {hw.checkedAt ? new Date(hw.checkedAt).toLocaleDateString("uk-UA") : "-"}
                                                </div>
                                            </CardContent>
                                        </Card>
                                    ))}
                            ...
                            {pendingHomeworks.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <CardContent className="space-y-4">
                                                ...
                                                <div className="flex items-center gap-2 text-[14px] font-[600] text-[#69686f] bg-white border border-slate-200 px-3 py-2 rounded-[8px] inline-flex">
                                                    ...
                                                    <span>
                                                        Здати до:{" "}
                                                        {hw.dueDate ? new Date(hw.dueDate).toLocaleDateString("uk-UA") : "-"}
                                                    </span>
                                                </div>
                                            </CardContent>
                                        </Card>
                                ...
                                <Card className="border-slate-200/80 shadow-[0_4px_12px_rgba(0,0,0,0.03)] rounded-[20px] border-dashed">
                                    <CardContent className="flex flex-col items-center justify-center py-16">
                                        ...
                                        <p className="text-[14px] text-[#69686f] mt-1">
                                            Ваші учні успішно виконали всі завдання
                                        </p>
                                    </CardContent>
                                </Card>
                            )}
                    ...
                    <DialogContent className="max-w-2xl rounded-[24px] p-8 font-sans">
                        ...
                        <div className="space-y-6 py-2">
                            <div className="bg-[#f0f3f3] p-5 rounded-[16px] space-y-4">
                                <div className="space-y-1.5">
                                    <Label className="text-[13px] font-[600] text-[#69686f] uppercase tracking-wider">
                                        Завдання
                                    </Label>
                                    <p className="text-[15px] text-[#121117] leading-relaxed">
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="grade" className="text-[15px] font-[600] text-[#121117]">
                                    Оцінка *
                                </Label>
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-[13px] text-[#69686f]">
                                    Цей тег буде видно учню та батькам у їхньому кабінеті
                                </p>
                            </div>

                            <div className="space-y-3">
                                <Label htmlFor="feedback" className="text-[15px] font-[600] text-[#121117]">
                                    Коментар до ДЗ та звіт для батьків *
                                </Label>
                                <Textarea
                                    id="feedback"
                                    value={feedback}
                    ...
                    <DialogContent className="max-w-md rounded-[24px] p-8 font-sans">
                        ...
                        <div className="space-y-5 py-2">
                            <div className="space-y-2">
                                <Label htmlFor="hw-client" className="text-[14px] font-[600] text-[#121117]">
                                    Учень *
                                </Label>
                                <Select value={newHwClient} onValueChange={setNewHwClient}>
                                    ...
                                    <SelectContent className="rounded-[12px]">
                                        {activeClients.map((client) => (
                                            <SelectItem key={client.id} value={client.id} className="rounded-[8px]">
                                                {client.name}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="hw-title" className="text-[14px] font-[600] text-[#121117]">
                                    Назва завдання *
                                </Label>
                                <Input
                                    id="hw-title"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="hw-desc" className="text-[14px] font-[600] text-[#121117]">
                                    Опис та інструкції
                                </Label>
                                <Textarea
                                    id="hw-desc"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="hw-due" className="text-[14px] font-[600] text-[#121117]">
                                    Термін здачі *
                                </Label>
                                <Input
                                    id="hw-due"
                            ...
                            <div className="space-y-2">
                                <Label className="text-[14px] font-[600] text-[#121117]">
                                    Додати матеріали (PDF, Audio, Image)
                                </Label>
