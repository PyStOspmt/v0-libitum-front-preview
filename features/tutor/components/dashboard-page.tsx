...
import { ArrowRight, Award, BarChart3, CheckCircle2, Clock, Coins, DollarSign, Flame, Star, Target, Users } from "lucide-react"
                            ...
                            {goals.map((goal) => (
                                ...
                                >
                                    ...
                                    {!goal.completed && (
                                        <Badge
                                            variant="outline"
                                            className="ml-auto text-[12px] text-[#ff9800] border-[#ff9800]/30 bg-[#fff8e1]/50"
                                        >
                                            +10 XP
                                        </Badge>
                                    )}
