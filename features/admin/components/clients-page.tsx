...
import { Ban, CheckCircle2, Eye, LogIn, Mail, Phone, Search } from "lucide-react"
                    ...
                    <Tabs defaultValue="all" className="w-full">
                        <TabsList className="bg-[#f0f3f3] rounded-[12px] p-1 border-0">
                            ...
                            <TabsTrigger
                                ...
                                className="rounded-[8px] data-[state=active]:bg-white data-[state=active]:text-[#121117] data-[state=active]:shadow-sm font-[600] text-[#69686f]"
                            >
                                Заблоковані ({blockedClients.length})
                            </TabsTrigger>
                        </TabsList>
                    ...
                    <div className="flex-1 space-y-3 min-w-0">
                        ...
                        <div className="flex gap-4 text-[14px] font-[600] text-[#121117] flex-wrap bg-[#f0f3f3]/50 p-3 rounded-[12px] border border-slate-200/80">
                            <span className="flex items-center gap-1.5">
                                <span className="text-[#69686f] font-[500]">Всього бронювань:</span> {client.totalBookings}
                            </span>
                            <span className="flex items-center gap-1.5">
                                <span className="text-[#69686f] font-[500]">Активні:</span> {client.activeBookings}
                            </span>
                            <span className="flex items-center gap-1.5">
                                <span className="text-[#69686f] font-[500]">Завершені заняття:</span> {client.completedLessons}
                            </span>
                            <span className="flex items-center gap-1.5">
                                <span className="text-[#69686f] font-[500]">Приєднався:</span>{" "}
                                {new Date(client.joinedDate).toLocaleDateString("uk-UA")}
                            </span>
                        </div>
                        ...
                        {client.role === "parent" && client.childName && (
                            <div className="text-[14px] font-[500] text-[#69686f]">
                                ...
                                <Badge
                                    variant="secondary"
                                    className="rounded-[6px] bg-white text-[#121117] border border-slate-200/80 font-[500] ml-1"
                                >
                                    {client.childName}
                                </Badge>
                            </div>
                            ...
                            <DialogContent className="rounded-[24px] border-0 shadow-[0_8px_32px_rgba(0,0,0,0.08)] sm:max-w-xl font-sans">
                                <DialogHeader className="pb-4 border-b border-slate-200/80">
                                    ...
                                    <DialogDescription className="text-[#69686f] font-[500] text-[15px]">
                                        Повна інформація про {client.name}
                                    </DialogDescription>
                                </DialogHeader>
                                            ...
                                            <AlertDialogContent className="rounded-[24px] border-0 shadow-[0_8px_32px_rgba(0,0,0,0.08)] font-sans">
                                                <AlertDialogHeader>
                                                    <AlertDialogTitle className="text-[20px] font-[700] text-[#121117]">
                                                        Підтвердити Support Access
                                                    </AlertDialogTitle>
                                                    <AlertDialogDescription className="text-[#69686f] font-[500]">
                                                        Ви перейдете в кабінет клієнта без зміни його пароля. Дія доступна лише
                                                        для Super Admin.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
                        ...
                        <AlertDialog open={supportConfirmOpen} onOpenChange={setSupportConfirmOpen}>
                            <AlertDialogTrigger asChild>
                                <Button
                                    ...
                                    variant="outline"
                                    disabled={client.status !== "active"}
                                    className="w-full sm:w-auto rounded-[8px] border-slate-200/80 text-[#121117] font-[600] hover:bg-[#e8fffb] hover:text-[#00a389] hover:border-[#00c5a6]/20 shadow-sm"
                                >
                                    <LogIn className="mr-2 h-4 w-4" />
                                    Support Access
                                </Button>
