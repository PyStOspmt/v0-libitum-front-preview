                ...
                <div className="container mx-auto max-w-6xl space-y-6 p-6 font-sans">
                    <div className="space-y-1">
                        ...
                        <p className="text-[15px] font-[500] text-[#69686f]">
                            Редагування мета-тегів та SEO-текстів для публічних сторінок.
                        </p>
                    </div>
                    ...
                    <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                        <CardHeader>
                            ...
                            <CardDescription className="text-[#69686f] font-[500]">
                                Оберіть сторінку для редагування мета-даних.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            {pages.map((page) => (
                                <div
                                    key={page.path}
                                    className="flex flex-wrap items-center justify-between gap-2 rounded-[16px] border border-slate-200/80 bg-[#f0f3f3]/50 p-4 transition-colors hover:bg-[#f0f3f3]"
                                >
                                    <div>
                                        <div className="text-[16px] font-[700] text-[#121117]">{page.title}</div>
                                        <div className="text-[13px] font-[500] text-[#69686f] mt-1 bg-white px-2 py-0.5 rounded-[6px] border border-slate-200/80 inline-block font-mono">
                                            {page.path}
                                        </div>
                                    </div>
                                    <Dialog
                                        open={selected?.path === page.path}
                                        ...
                                        <DialogContent className="rounded-[24px] border-0 shadow-[0_8px_32px_rgba(0,0,0,0.08)] font-sans sm:max-w-lg">
                                            <DialogHeader className="pb-4 border-b border-slate-200/80">
                                                ...
                                                <DialogDescription className="text-[#69686f] font-[500] text-[15px]">
                                                    Мета-теги та контент для {page.path}
                                                </DialogDescription>
                                            </DialogHeader>
