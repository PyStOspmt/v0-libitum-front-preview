                    ...
                    <Tabs defaultValue="homework" className="w-full">
                        ...
                        <TabsContent value="homework" className="space-y-6">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                {homeworks.length === 0 && (
                                    <p className="col-span-full py-12 text-center text-muted-foreground italic">
                                        Завдань поки немає
                                    </p>
                                )}
                            </div>
                                ...
                                {materials.map((m, idx) => (
                                    <Card key={idx}>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                {m.subject} • {new Date(m.date).toLocaleDateString("uk-UA")}
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
                ...
                <Dialog open={!!selectedHomework} onOpenChange={() => setSelectedHomework(null)}>
                    <DialogContent>
                        ...
                        <DialogFooter>
                            ...
                            <Button onClick={handleSubmitHomework} disabled={!submissionText}>
                                Відправити вчителю
                            </Button>
                        </DialogFooter>
                    </DialogContent>
