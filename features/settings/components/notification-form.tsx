...
import { type NotificationValues, notificationSchema } from "@/features/settings/schemas/settings.schema"
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                                ...
                                <FormDescription>Отримуйте нагадування про майбутні заняття на email</FormDescription>
                            </div>
                            <FormControl>
                                <Switch
                                    checked={field.value}
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                            <div className="space-y-0.5">
                                ...
                                <FormDescription>Отримуйте нагадування про майбутні заняття по SMS</FormDescription>
                            </div>
                            <FormControl>
                                <Switch
                                    checked={field.value}
