...
export function SpecialistProfilePage({ id }: { id: string }) {
    ...
    const specialistsDB: Record<string, any> = {
        ...
        "3": {
            ...
            subjectsDetails: [
                ...
                },
                {
                    ...
                    levels: [{ label: "Пара", priceOnline: 900, priceOffline: 1000 }],
                    groupAvailable: false,
                },
            ],
            rating: 5.0,
        ...
        "4": {
            ...
            videoIntroUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
            certificates: [{ title: "Логопед-дефектолог", description: "Вища категорія" }],
    ...
    const reviews = [
        ...
        },
        {
            ...
            rating: 5,
            date: "28.12.2024",
            text: "Дуже задоволений результатами! Олена допомогла подолати мовний бар'єр. Тепер спілкуюся англійською впевнено.",
        },
        {
            id: 5,
            clientName: "Оксана М.",
            rating: 5,
            date: "20.12.2024",
            text: "Професійний підхід до кожного учня. Індивідуальна програма, яка дійсно працює. Рекомендую!",
        },
        {
            id: 6,
            clientName: "Сергій Т.",
            rating: 4,
            date: "15.12.2024",
            text: "Хороший викладач, пояснює складні теми просто. Іноді занять відбуваються онлайн з невеликими затримками.",
        },
        {
            id: 7,
            ...
            rating: 5,
            date: "10.12.2024",
            text: "Олена - найкращий викладач, з яким я займався! Результат перевершив усі очікування. Дякую!",
        },
        {
            id: 8,
            clientName: "Дмитро В.",
            rating: 5,
            date: "05.12.2024",
            text: "Системний підхід, чудові матеріали. Підготувався до співбесіди в міжнародну компанію.",
        },
    ]
            ...
            <div className="border-b border-slate-100 bg-[#f8f9fa]">
                <div className="container mx-auto px-4 lg:px-8 py-3">
                    <nav className="flex items-center gap-1.5 text-sm text-[#69686f] font-medium">
                        ...
                        <Link href={specialistsListHref} className="hover:text-[#121117] transition-colors">
                            Спеціалісти
                        </Link>
                        <ChevronRight className="h-3.5 w-3.5" />
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="mb-4 sm:mb-6 bg-white rounded-[24px] sm:rounded-3xl p-5 sm:p-8 border border-slate-200 shadow-[0_4px_20px_rgb(0,0,0,0.03)] sm:shadow-sm relative overflow-hidden">
                            ...
                            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center gap-2 z-20">
                                ...
                                >
                                    <Heart
                                        className={`h-4 w-4 transition-colors ${wishlisted ? "fill-[#ff4757] text-[#ff4757]" : "text-slate-400 group-hover:text-slate-600"}`}
                                    />
                                </button>
                                <button
                                    onClick={handleShare}
                                ...
                                <div className="relative shrink-0 mx-auto sm:mx-0 mt-2 sm:mt-0 sm:w-[220px]">
                                    <div className="relative h-[130px] w-[130px] sm:h-[180px] sm:w-[180px] rounded-full overflow-hidden ring-4 ring-slate-50 shadow-sm mx-auto sm:mx-0">
                                        <Avatar className="h-full w-full rounded-none">
                                            ...
                                            />
                                            <AvatarFallback className="text-4xl font-bold bg-[#f0f3f3] text-[#121117]">
                                                {specialist.name[0]}
                                            </AvatarFallback>
                                        </Avatar>
                                    </div>
                                    {specialist.verified && (
                                        <div className="absolute bottom-0 right-0 sm:bottom-2 sm:right-6 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-white border-2 border-slate-50 shadow-sm z-10">
                                            <Award
                                                className={`h-5 w-5 sm:h-6 sm:w-6 ${specialist.specialization === "Репетитор" ? "text-[#00c5a6]" : "text-[#f57c00]"}`}
                                            />
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="flex-1 pt-1 sm:pt-2 text-center sm:text-left w-full sm:pr-20">
                                    <div className="mb-4 sm:mb-5 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-3 sm:gap-4">
                                        <div className="space-y-3 w-full">
                                            <h1 className="text-[28px] sm:text-[36px] font-bold text-[#121117] leading-tight tracking-tight">
                                                {specialist.name}
                                            </h1>
                                            <div className="flex flex-wrap justify-center sm:justify-start items-center gap-2">
                                                <span
                                                    className={`inline-flex items-center rounded-lg px-3 py-1.5 sm:px-3 sm:py-1.5 text-[13px] sm:text-[14px] font-[700] ${specialist.specialization === "Репетитор" ? "bg-[#e8fffb] text-[#00a389]" : "bg-[#fff8e1] text-[#d87b00]"}`}
                                                >
                                                ...
                                                {specialist.badges.map((badge: string) => (
                                                    <span
                                                        key={badge}
                                                        className="inline-flex items-center rounded-lg bg-slate-100 px-3 py-1.5 sm:px-3 sm:py-1.5 text-[12px] sm:text-[13px] font-[600] text-slate-700"
                                                    >
                                                        {badge}
                                                    </span>
                                                ))}
                                        ...
                                        <div className="flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-x-6 gap-y-3 sm:gap-y-0 text-[14px] text-[#69686f] font-medium bg-[#f8f9fa] p-3.5 sm:p-4 rounded-[16px] w-full sm:w-fit border border-slate-100 mx-auto sm:mx-0">
                                            <div className="flex items-center justify-between sm:justify-start w-full sm:w-auto gap-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-bold text-[#121117] text-[16px]">
                                                        {specialist.rating}
                                                    </span>
                                                </div>
                                            ...
                                            <div className="flex items-center justify-between sm:justify-start w-full sm:w-auto gap-3">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className="text-slate-600 font-[600]">
                                                        <strong className="text-[#121117]">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 mt-2 w-full">
                                            ...
                                            <div className="flex flex-wrap justify-center sm:justify-start gap-1.5 w-full max-w-[500px]">
                                                {specialist.subjects.map((subject: string) => (
                                                    <span
                                                        key={subject}
                                                        className="inline-flex items-center rounded-lg bg-white border border-slate-200 px-2.5 py-1 text-[13px] font-[600] text-[#121117] shadow-sm hover:border-slate-300 hover:shadow-md transition-all cursor-default"
                                                    >
                                                        {subject}
                                                    </span>
                                                ))}
                        ...
                        <div className="sticky top-[72px] sm:top-[80px] z-30 bg-white/95 backdrop-blur-md pb-0 pt-2 mb-6 border-b border-slate-200/60 no-scrollbar">
                            <div className="flex items-center gap-2 sm:gap-4 overflow-x-auto no-scrollbar w-full sm:px-1">
                                ...
                                >
                                    Відгуки{" "}
                                    <span
                                        className={`ml-1 px-1.5 py-0.5 rounded-full text-[12px] ${activeSection === "reviews" ? "bg-[#121117] text-white" : "bg-slate-100 text-slate-500"}`}
                                    >
                                        {specialist.reviews}
                                    </span>
                                </a>
                        ...
                        <div className="space-y-8 sm:space-y-12 pb-10">
                                            ...
                                            {specialist.certificates.map((cert: { title: string; description: string }) => (
                                                <div key={cert.title} className="flex gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[#69686f] text-[13px] font-medium mt-0.5">
                                                            {cert.description}
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="grid gap-6">
                                        {specialist.subjectsDetails.map(
                                            (subject: {
                                                ...
                                                <div
                                                    key={subject.subject}
                                                    className="rounded-[16px] border border-slate-200/80 bg-white p-4 sm:p-6 hover:border-slate-300 transition-colors shadow-sm"
                                                >
                                                    <div className="mb-4 flex items-center justify-between">
                                                        <h4 className="text-[18px] font-bold text-[#121117]">
                                                            {subject.subject}
                                                        </h4>
                                                        ...
                                                        <div className="divide-y divide-slate-100 bg-white">
                                                            {subject.levels.map(
                                                                (level: {
                                                                    ...
                                                                    <div
                                                                        key={level.label}
                                                                        className="grid grid-cols-4 items-center px-3 sm:px-4 py-3 text-[13px] sm:text-[14px] hover:bg-[#fafaf8] transition-colors"
                                                                    >
                                                                        <span className="font-medium text-slate-800 pr-2 leading-tight">
                                                                            {level.label}
                                                                        </span>
                                                                        ...
                                                                        <span className="text-slate-600">
                                                                            {level.groupPrice ? `${level.groupPrice} ₴` : "---"}
                                                                        </span>
                                                                    </div>
                                                                ),
                                                            )}
                            ...
                            <section id="reviews" className="scroll-mt-32 space-y-4 block">
                                ...
                                {reviews.slice(0, showAllReviews ? reviews.length : 3).map((review) => (
                                    <div
                                        key={review.id}
                                        className="rounded-[16px] border border-slate-200/80 bg-white p-5 sm:p-6 hover:border-slate-300 transition-colors shadow-[0_2px_10px_rgb(0,0,0,0.02)]"
                                    >
                                        <div className="mb-4 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[13px] font-medium text-[#69686f] mt-0.5">
                                                        {review.date}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="sticky top-24 flex flex-col gap-4 pb-6">
                            ...
                            <div className="rounded-[24px] border border-slate-200/80 bg-white overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] shrink-0">
                                <div className="bg-white p-4 sm:p-6 border-b border-slate-100 text-center relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <p className="text-[13px] font-[600] text-[#69686f] mb-2 uppercase tracking-wider">
                                            Вартість заняття
                                        </p>
                                        <div className="flex items-end justify-center gap-1.5 mb-1">
                                            <span className="text-[36px] font-bold text-[#121117] leading-none">
                                                {specialist.priceOnline} ₴
                                            </span>
                                            <span className="text-[16px] font-[600] text-[#69686f] mb-1">/ год</span>
                                        </div>
                                        <p
                                            className={`text-[13px] mt-2 font-bold inline-block px-3 py-1 rounded-full ${specialist.specialization === "Репетитор" ? "text-[#00a389] bg-[#e8fffb]" : "text-[#d87b00] bg-[#fff8e1]"}`}
                                        >
                            ...
                            <div className="rounded-[24px] border border-slate-200/80 bg-white p-4 sm:p-6 shadow-[0_2px_10px_rgb(0,0,0,0.02)]">
                                <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                                    ...
                                    <div className="text-center">
                                        <div
                                            className={`text-[24px] font-bold ${specialist.specialization === "Репетитор" ? "text-[#00c5a6]" : "text-[#f57c00]"}`}
                                        >
                                            {specialist.completedSessions}
                                        </div>
                            ...
                            <div className="rounded-[24px] p-4 sm:p-5 border border-slate-200/80 bg-gradient-to-br from-white to-[#f0f3f3]/40 shadow-[0_2px_10px_rgb(0,0,0,0.02)] flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Shield
                                            className={`h-4 w-4 ${specialist.specialization === "Репетитор" ? "text-[#00c5a6]" : "text-[#f57c00]"}`}
                                        />
                                    </div>
                                </div>
                                <div
                                    className={`h-10 w-10 shrink-0 rounded-full flex items-center justify-center border ${specialist.specialization === "Репетитор" ? "bg-[#e8fffb] border-[#00c5a6]/20" : "bg-[#fff8e1] border-[#f57c00]/20"}`}
                                >
                                    <Star
                                        className={`h-5 w-5 ${specialist.specialization === "Репетитор" ? "text-[#00c5a6]" : "text-[#f57c00]"}`}
                                    />
                                </div>
                            </div>
                            ...
                            {/* Guarantee */}
                            <div
                                className={`rounded-[16px] p-5 text-center border ${specialist.specialization === "Репетитор" ? "bg-[#e8fffb] border-[#00c5a6]/20" : "bg-[#fff8e1] border-[#f57c00]/20"}`}
                            >
                                <div className="flex items-center justify-center gap-2 mb-2">
                                    <Check
                                        className={`h-5 w-5 ${specialist.specialization === "Репетитор" ? "text-[#00a389]" : "text-[#d87b00]"}`}
                                    />
                                    <span
                                        className={`text-[15px] font-bold ${specialist.specialization === "Репетитор" ? "text-[#00a389]" : "text-[#d87b00]"}`}
                                    >
                                        Гарантія якості
                                    </span>
                                </div>
                                <p
                                    className={`text-[13px] font-medium leading-relaxed ${specialist.specialization === "Репетитор" ? "text-[#00a389]/80" : "text-[#d87b00]/80"}`}
                                >
