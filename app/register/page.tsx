        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10">
          <div className="w-full max-w-[440px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={userType} onValueChange={(value) => setUserType(value as "client" | "specialist")} className="grid grid-cols-2 gap-3">
                  <div className={`flex flex-col items-center justify-center rounded-lg border p-4 transition-all cursor-pointer ${userType === "client" ? "border-[#00897B] bg-[#E0F2F1]" : "border-slate-200 bg-white hover:bg-slate-50"}`}>
              ...
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  className="mt-0.5 border-slate-300 data-[state=checked]:bg-[#00897B] data-[state=checked]:border-[#00897B]"
                />
                <label htmlFor="rules" className="text-sm leading-relaxed text-slate-500">
                  Я приймаю{" "}
                  <button type="button" onClick={() => setShowRules(true)} className="font-semibold text-[#00897B] hover:underline cursor-pointer">
                    правила платформи
                  </button>{" "}
            ...
            <div className="mt-8 text-center text-sm text-slate-500">
              Вже маєте акаунт?{" "}
              <Link href="/login" className="font-semibold text-[#00897B] hover:text-[#00796B]">
                Увійти
              </Link>
            </div>
          </div>
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto rounded-lg border border-slate-200">
          ...
          <div className="space-y-6 py-5 text-sm text-slate-600">
            <section className="space-y-4">
              <h3 className="font-bold text-base text-slate-800 flex items-center gap-3">
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#E0F2F1] text-[#00897B] text-xs font-bold">1</span>
                Для спеціалістів
              </h3>
            ...
            <section className="space-y-4">
              <h3 className="font-bold text-base text-slate-800 flex items-center gap-3">
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#E0F2F1] text-[#00897B] text-xs font-bold">2</span>
                Для учнів
              </h3>
              <ul className="space-y-3 pl-2">
                <li className="flex gap-3">
          ...
          <div className="flex items-center space-x-3 pt-5 border-t border-slate-100 mt-2">
            <Checkbox
              ...
              className="border-slate-300 data-[state=checked]:bg-[#00897B] data-[state=checked]:border-[#00897B]"
            />
