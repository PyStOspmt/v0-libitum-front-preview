        ...
        <div className="container mx-auto max-w-5xl space-y-6 p-6 font-sans">
          ...
          <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            <CardHeader>
              ...
              <CardDescription className="text-[#69686f] font-[500]">Вкажіть email користувача, щоб згенерувати тимчасовий доступ.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Input placeholder="email користувача" type="email" className="rounded-[8px] border-slate-200/80 focus-visible:ring-[#00c5a6]" />
              <Button className="rounded-[8px] bg-[#00c5a6] text-white hover:bg-[#00a389] font-[600] shadow-[0_2px_8px_rgba(0,197,166,0.2)]">Згенерувати доступ</Button>
