      ...
      <main className="relative scroll-smooth snap-y snap-mandatory">
        ...
        <section className="relative container mx-auto px-4 py-16 snap-start" id="how-it-works">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-3xl font-bold bg-gradient-to-r from-emerald-600 via-teal-500 to-amber-500 bg-clip-text text-transparent md:text-4xl">
              {t("nav.how_it_works")}
            </h2>
        ...
        <section className="relative container mx-auto px-4 py-16 snap-start" id="specialists">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Link href={`${specialistsCategoryHref}?category=tutor`} className="group">
              <div className="h-full rounded-2xl border border-slate-200 bg-gradient-to-br from-emerald-50/70 via-white to-white overflow-hidden shadow-sm transition-all hover:shadow-lg hover:border-emerald-200 hover:-translate-y-1">
                <div className="p-8 h-full flex flex-col">
                  <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 text-emerald-600 transition-transform group-hover:scale-110">
                  ...
                  <div className="flex items-center justify-between text-sm font-medium border-t border-slate-100 pt-6">
                    ...
                    <div className="h-8 w-8 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-emerald-500 group-hover:to-teal-400 transition-colors">
            ...
            <Link href={`${specialistsCategoryHref}?category=psychologist`} className="group">
              <div className="h-full rounded-2xl border border-slate-200 bg-gradient-to-br from-amber-50/70 via-white to-white overflow-hidden shadow-sm transition-all hover:shadow-lg hover:border-amber-200 hover:-translate-y-1">
                <div className="p-8 h-full flex flex-col">
                  <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 text-amber-600 transition-transform group-hover:scale-110">
                    <Brain className="h-8 w-8" />
                  </div>
                  <h3 className="mb-2 text-2xl font-bold text-slate-800 group-hover:text-amber-600 transition-colors">{t("categories.psychologist.title")}</h3>
                  <p className="text-base text-slate-500 mb-8 flex-1">{t("categories.psychologist.desc")}</p>
                  
                  <div className="flex items-center justify-between text-sm font-medium border-t border-slate-100 pt-6">
                    <span className="text-slate-400 group-hover:text-amber-600 transition-colors">{t("categories.psychologist.stat")}</span>
                    <div className="h-8 w-8 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-amber-400 group-hover:to-orange-400 transition-colors">
                      <ArrowRight className="h-4 w-4 text-slate-400 group-hover:text-white transition-colors" />
                    </div>
                  </div>
                </div>
            ...
            <Link href={`${specialistsCategoryHref}?category=speech-therapist`} className="group">
              <div className="h-full rounded-2xl border border-slate-200 bg-gradient-to-br from-amber-50/70 via-white to-white overflow-hidden shadow-sm transition-all hover:shadow-lg hover:border-amber-200 hover:-translate-y-1">
                <div className="p-8 h-full flex flex-col">
                  ...
                  <h3 className="mb-2 text-2xl font-bold text-slate-800 group-hover:text-amber-600 transition-colors">{t("categories.speech.title")}</h3>
                  <p className="text-base text-slate-500 mb-8 flex-1">{t("categories.speech.desc")}</p>
                  
                  <div className="flex items-center justify-between text-sm font-medium border-t border-slate-100 pt-6">
                    <span className="text-slate-400 group-hover:text-amber-600 transition-colors">{t("categories.speech.stat")}</span>
                    <div className="h-8 w-8 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-gradient-to-r group-hover:from-amber-400 group-hover:to-orange-400 transition-colors">
                      <ArrowRight className="h-4 w-4 text-slate-400 group-hover:text-white transition-colors" />
                    </div>
                  </div>
        ...
        <section className="relative container mx-auto px-4 py-20">
          <div className="rounded-2xl border border-slate-200 bg-white px-6 py-16 text-center shadow-sm md:px-16 hover-glow">
            <h2 className="mb-6 text-4xl font-bold bg-gradient-to-r from-emerald-600 via-teal-500 to-amber-500 bg-clip-text text-transparent md:text-5xl tracking-tight">{t("cta.title")}</h2>
