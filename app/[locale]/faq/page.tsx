...
export const metadata = {
    title: "FAQ | Libitum",
    description: "Відповіді на найчастіші запитання про Libitum.",
}
                    ...
                    {[
                        {
                            ...
                            description:
                                "Оберіть предмет у каталозі, перегляньте профіль викладача або створіть загальну заявку у кабінеті клієнта.",
                        },
                        {
                            title: "Як репетитору отримати доступ до лідів?",
                            description:
                                "Необхідно пройти онбординг та модерацію профілю. Після активації доступна біржа заявок.",
                        },
                        {
