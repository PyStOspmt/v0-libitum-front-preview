...
const rulesSections = [
    ...
    },
    {
        ...
        description: "Вчасно підтверджуйте заняття, залишайте коректні дані та реагуйте на запити репетитора протягом SLA.",
    },
    {
        title: "Правила для репетиторів",
        description: "Після отримання ліда треба звʼязатися з клієнтом та зафіксувати дату пробного уроку в системі.",
    },
    {
