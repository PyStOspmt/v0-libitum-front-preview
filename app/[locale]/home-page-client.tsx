        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-4 gap-12 text-[15px]">
          ...
          <div>
            ...
            <div className="space-y-4">
              <LocaleLink href={specialistHref} className="block text-[#69686f] hover:text-[#121117] transition-colors">{t("nav.specialists")}</LocaleLink>
              <LocaleLink href="#how" className="block text-[#69686f] hover:text-[#121117] transition-colors">{t("nav.how_it_works")}</LocaleLink>
              <LocaleLink href="#faq" className="block text-[#69686f] hover:text-[#121117] transition-colors">{t("nav.reviews")}</LocaleLink>
            </div>
          </div>
        </div>
