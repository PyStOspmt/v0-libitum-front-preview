                            ...
                            {faqs.map((faq, idx) => (
                                <div key={faq.q} className="border-b border-gray-100 last:border-0">
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 ${openFaq === idx ? "bg-[#e8fffb] text-[#00c5a6]" : "bg-slate-100 text-slate-500"}`}
                                        >
                                            <ChevronDown
                ...
                <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-4 gap-12 text-[15px]">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <LocaleLink
                                href={specialistHref}
                                className="block text-[#69686f] hover:text-[#121117] transition-colors"
                            >
                                {t("nav.specialists")}
                            </LocaleLink>
                            <LocaleLink href="#how" className="block text-[#69686f] hover:text-[#121117] transition-colors">
                                {t("nav.how_it_works")}
                            </LocaleLink>
                            <LocaleLink href="#faq" className="block text-[#69686f] hover:text-[#121117] transition-colors">
                                {t("nav.reviews")}
                            </LocaleLink>
                        </div>
                    </div>
