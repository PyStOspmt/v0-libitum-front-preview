import { ArrowRight, Award, BookOpen, Shield, Star, Users } from "lucide-react"
    ...
    const features = [
        {
            ...
            description:
                t("about.page.desc") ||
                "Тисячі перевірених спеціалістів з детальними профілями, відгуками та реальними результатами.",
            link: "/specialists",
        ...
        },
        {
            ...
            description:
                t("about.page.desc3") || "Об'єктивні оцінки від реальних клієнтів допомагають обрати найкращого викладача.",
            link: "/specialists",
                ...
                <div className="space-y-8">
                    <div className="text-center">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">
                            {t("about.features.title") || "Чому обирають Libitum?"}
                        </h2>
