...
import { BookOpen, ArrowLeft, Award, TrendingUp, Star, Clock, CheckCircle2, Target, Zap } from "lucide-react"
import Link from "next/link"

export default function SpecialistStatsPage() {
  const { user } = useAuth()
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-xl font-semibold">Статистика та досягнення</h1>
              </div>
            </div>
          </div>
        </header>
