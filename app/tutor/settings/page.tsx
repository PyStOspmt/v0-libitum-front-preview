        ...
        <div className="container mx-auto max-w-4xl space-y-8 p-6 font-sans">
          ...
          <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            <CardHeader>
              ...
              <CardDescription className="text-[#69686f] font-[500]">Змініть пароль та налаштування безпеки</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
          ...
          <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            <CardHeader>
              ...
              <CardDescription className="text-[#69686f] font-[500]">Додайте відео "Як я проводжу заняття" щоб збільшити довіру клієнтів</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {profileVideoUrl ? (
          ...
          <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)] overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-indigo-50/50 to-purple-50/50 border-b border-indigo-100/50">
              ...
              <CardDescription className="text-[#69686f] font-[500]">Запрошуйте колег-спеціалістів та отримуйте бонуси</CardDescription>
            </CardHeader>
          ...
          <Card className="rounded-[24px] border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
            <CardHeader>
              ...
              <CardDescription className="text-[#69686f] font-[500]">Налаштуйте, як ви отримуєте сповіщення</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-2 hover:bg-[#f0f3f3] rounded-[12px] transition-colors">
                ...
                <Button variant="outline" size="sm" className="rounded-[8px] border-slate-200/80 font-[600] text-[#121117]">Увімкнено</Button>
              </div>
              ...
              <div className="flex items-center justify-between p-2 hover:bg-[#f0f3f3] rounded-[12px] transition-colors">
                ...
                <Button variant="outline" size="sm" className="rounded-[8px] border-slate-200/80 font-[600] text-[#69686f] bg-[#f0f3f3]/50 hover:bg-[#f0f3f3]">Вимкнено</Button>
              </div>
              <Separator className="bg-slate-200/80" />
              <div className="flex items-center justify-between p-2 hover:bg-[#f0f3f3] rounded-[12px] transition-colors">
                <div>
                  <p className="font-[600] text-[#121117]">Сповіщення про нові запити</p>
                  <p className="text-[13px] font-[500] text-[#69686f]">Отримувати сповіщення про нові запити від клієнтів</p>
                </div>
                <Button variant="outline" size="sm" className="rounded-[8px] border-slate-200/80 font-[600] text-[#121117]">Увімкнено</Button>
              </div>
            </CardContent>
