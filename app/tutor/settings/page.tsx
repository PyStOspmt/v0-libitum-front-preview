        ...
        <div className="container mx-auto max-w-4xl space-y-8 p-6">
          ...
          <Card className="border-slate-200/70 bg-white/80 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="rounded-full">Зберегти зміни</Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-slate-200/70 bg-white/80 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="rounded-full">Змінити пароль</Button>
            </CardContent>
          </Card>
              ...
              {profileVideoUrl ? (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button variant="outline" onClick={() => setProfileVideoUrl("")} className="rounded-full">
                      Видалити
                    </Button>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/60 p-12">
                    ...
                    <div className="flex w-full max-w-md gap-2">
                      <Input
                        ...
                        placeholder="https://youtube.com/watch?v=..."
                      />
                      <Button onClick={handleSaveVideo} className="rounded-full">Додати</Button>
                    </div>
                  </div>
          ...
          <Card className="border-slate-200/70 bg-white/80 shadow-sm">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-3 gap-4">
                <div className="rounded-2xl border border-slate-200/60 bg-white/70 p-4 text-center">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" size="icon" onClick={copyReferralLink} className="rounded-full">
              ...
              <div className="flex gap-2">
                <Button variant="outline" className="flex-1 bg-transparent rounded-full">
              ...
              <div className="rounded-2xl border border-emerald-200/60 bg-emerald-50/70 p-4">
                <p className="text-sm font-medium text-emerald-900">Як це працює:</p>
          ...
          <Card className="border-slate-200/70 bg-white/80 shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" className="rounded-full">Увімкнено</Button>
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div>
                ...
                <Button variant="outline" className="rounded-full">Вимкнено</Button>
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div>
